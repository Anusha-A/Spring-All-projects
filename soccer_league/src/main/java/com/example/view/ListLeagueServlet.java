...
import com.example.model.ListLeague;
...
public class ListLeagueServlet extends HttpServlet {
	...
	private List<ListLeague> list=null;
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list=new ArrayList<ListLeague>();
		list.add(new ListLeague("Autumn",2019,"Women's Cricket"));
		list.add(new ListLeague("Summer", 2019, "Beach Volley"));
		list.add(new ListLeague("Winter", 2019, "Basket Ball"));
