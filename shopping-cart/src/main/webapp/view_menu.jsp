...
<p>
	...
	<a href="view_card.jsp">View Cart</a>
	<p />
	<table width="75%" border="1">
		<tr>
			<td><form method="POST" action="cardController.do">
					...
					<strong>Quantity:<input type="text" size="2" value="1"name="quantity">
					</strong> <strong>Price:</strong> $10.00 <input type="hidden" name="price" value="10"> 
					<input type="hidden" name="action" value="add"> 
					<input type="submit" name="addToCart" value="Add To Cart">
				</form></td>
			<td>
				<form  method="POST" action="cardController.do">
