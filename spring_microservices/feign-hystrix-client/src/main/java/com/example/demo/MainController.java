...
public class MainController {
	...
	public Map<String,Collection> postOffersAndRecommendation() {
		Map<String,Collection> result=new HashMap<String,Collection>();
		result.put("offers", integrationClient.putOffers());
		result.put("recommendations", integrationClient.putRecommendations());
		return result;
